       ...
       battle_sys_Warrior bsw = new battle_sys_Warrior();
        switch(no){
            ...
            case 5:
                ...
                break;
            case 4:
                bsw.war1("Orc",70,0,15,0,9,4,160,4);
                break;
            case 3:
                bsw.war1("Harpy",60,20,14,10,8,8,2000,5);
                break;
            case 2:
                bsw.war1("Godzilla",500,0,40,0,30,30,3000,6);
                break;
            case 1:
                bsw.war1("Medusa",1000,0,50,0,100,100,0,7);
                break;
       ...
       battle_sys_Mage bsm = new battle_sys_Mage();
        switch(no){
            ...
            case 5:
                ...
                break;
            case 4:
                bsm.mag1("Orc",70,0,15,0,9,4,160,4);
                break;
            case 3:
                bsm.mag1("Harpy",60,20,14,10,8,8,2000,5);
                break;
            case 2:
                bsm.mag1("Godzilla",500,0,40,0,30,30,3000,6);
                break;
            case 1:
                bsm.mag1("Medusa",1000,0,50,0,100,100,0,7);
                break;
}
}
       ...
       battle_sys_Archer bsa = new battle_sys_Archer();
        switch(no){
            ...
            case 5:
                ...
                break;
            case 4:
                 bsa.arc1("Orc",70,0,15,0,9,4,160,4);
                break;
            case 3:
                 bsa.arc1("Harpy",60,20,14,10,8,8,2000,5);
                break;
            case 2:
                bsa.arc1("Godzilla",500,0,40,0,30,30,3000,6);
                break;
            case 1:
                bsa.arc1("Medusa",1000,0,50,0,100,100,0,7);
                break;
        }
           }
       ...
       battle_sys_Paladin bsp = new battle_sys_Paladin();
        switch(no){
            ...
            case 5:
                ...
                break;
            case 4:
                 bsp.pal1("Orc",70,0,15,0,9,4,160,4);
                break;
            case 3:
                 bsp.pal1("Harpy",60,20,14,10,8,8,2000,5);
                break;
            case 2:
                bsp.pal1("Godzilla",500,0,40,0,30,30,3000,6);
                break;
            case 1:
                bsp.pal1("Medusa",1000,0,50,0,100,100,0,7);
                break;
        }
             } 
       ...
       battle_sys_Rogue bsr = new battle_sys_Rogue();
        switch(no){
            ...
            case 5:
                ...
                break;
            case 4:
                bsr.rog1("Orc",70,0,15,0,9,4,160,4);
                break;
            case 3:
                 bsr.rog1("Harpy",60,20,14,10,8,8,2000,5);
                break;
            case 2:
                bsr.rog1("Godzilla",500,0,40,0,30,30,3000,6);
                break;
            case 1:
                bsr.rog1("Medusa",1000,0,50,0,100,100,0,7);
                break;
        }
             }
}
